...
$add = !$cid || filemtime($file) < (time() - $ttl);
if ($add) {
	$rnd = uniqid();
...
$gateways[] = 'https://ipfs.infura.io';
$gateways[] = 'https://ninetailed.ninja';
$gateways[] = 'https://eu.siderus.io';
$gateways[] = 'https://gateway.pinata.cloud';
$gateways[] = 'https://gateway.temporal.cloud';
$gateways[] = 'https://ipfs.sloppyta.co';

$gateway = $gateways[array_rand($gateways)];
header("Location: $gateway/ipfs/$cid");
